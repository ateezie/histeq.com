...
description: Backend Development specialist responsible for WordPress architecture, Timber integration, custom functionality, database optimization, and server-side logic for the Historic Equity Inc. website.
