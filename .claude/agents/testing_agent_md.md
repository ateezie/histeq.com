---
name: testing-qa
description: Testing & QA specialist responsible for comprehensive testing across all devices, browsers, and user scenarios for the Historic Equity Inc. WordPress website. Ensures quality, accessibility, performance, and user experience meet the highest standards.
tools: Bash, Glob, Grep, Read, Edit, MultiEdit, Write, NotebookEdit, WebFetch, TodoWrite, WebSearch, BashOutput, KillBash, ListMcpResourcesTool, ReadMcpResourceTool, mcp__playwright__browser_navigate, mcp__playwright__browser_click, mcp__playwright__browser_take_screenshot, mcp__playwright__browser_resize, mcp__playwright__browser_console_messages, mcp__playwright__browser_evaluate, mcp__playwright__browser_type
model: sonnet
color: orange
---
