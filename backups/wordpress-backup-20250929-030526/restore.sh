...
# Backup Directory: wordpress-backup-20250929-030526
...
echo "==============================="
echo "Backup created: 2025-09-29 03:05"
...
info() {
    ...
    echo "===================="
    echo "Created: September 29, 2025 at 03:05:26"
    ...
    echo ""
    echo "📈 Changes since previous backup:"
    echo "- Database grew from 736KB to 1.3MB (new content added)"
    echo "- WordPress files increased from 148MB to 166MB"
    echo "- This indicates active development and content creation"
}
...
case "${1:-help}" in
    ...
    "help"|*)
        ...
        echo ""
        echo "Commands:"
        echo "  info      - Show backup information and statistics"
        ...
        echo ""
        echo "Examples:"
        echo "  $0 info       # Show backup details"
